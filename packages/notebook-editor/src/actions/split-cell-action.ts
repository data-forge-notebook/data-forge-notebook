...
export class SplitCellAction implements IAction {
    ...
    async invoke(context: IActionContext): Promise<IChange[] | void> {
        ...
        const caretOffset = cell.caretOffset;
        ...
        return [
            ...
            new AddCellChange(notebook, cellIndex, cell.text.substring(0, caretOffset), cell.cellType, false),
            new AddCellChange(notebook, cellIndex + 1, cell.text.substring(caretOffset), cell.cellType, true),
        ];
    }
}
