...
let CodeEditorWidget = class CodeEditorWidget extends Disposable {
    constructor(domElement, options, codeEditorWidgetOptions, instantiationService, codeEditorService, commandService, contextKeyService, themeService, notificationService, accessibilityService) {
        ...
        this._register(this._configuration.onDidChange((e) => {
            ...
            if (e.hasChanged(116 /* layoutInfo */)) {
    ...
    getConfiguredWordAtPosition(position) {
        ...
        return WordOperations.getWordAtPosition(this._modelData.model, this._configuration.options.get(104 /* wordSeparators */), position);
    }
    ...
    _createView(viewModel) {
        ...
        const view = new View(commandDelegate, this._configuration, this._themeService, viewModel, viewUserInputEvents);
        return [view, true];
    }
...
class EditorContextKeysManager extends Disposable {
    ...
    _updateFromConfig() {
        ...
        this._editorTabMovesFocus.set(options.get(115 /* tabFocusMode */));
