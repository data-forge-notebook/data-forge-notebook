    ...
    run(accessor, editor) {
        return __awaiter(this, void 0, void 0, function* () {
            if (editor.hasModel()) {
                ...
                yield instaService.invokeFunction(formatDocumentWithSelectedProvider, editor, 1 /* Explicit */, Progress.None, CancellationToken.None);
            }
        });
    }
}
class FormatSelectionAction extends EditorAction {
    ...
    run(accessor, editor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield instaService.invokeFunction(formatDocumentRangeWithSelectedProvider, editor, range, 1 /* Explicit */, CancellationToken.None);
        });
    }
}
